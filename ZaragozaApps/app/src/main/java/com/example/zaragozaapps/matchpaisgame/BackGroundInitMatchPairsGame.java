 ...
 */
public class BackGroundInitMatchPairsGame extends AsyncTask<String,Void,String> {
    ...
    public BackGroundInitMatchPairsGame(Context context) {
    ...
    protected void onPostExecute(String result) {
        Log.e("INIT FIN","INIT FIN");
        new WaitForStartMatchPairsGame(context).execute(id);
    }
